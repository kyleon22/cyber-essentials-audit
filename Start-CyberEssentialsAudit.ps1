...
function Show-Help {
    ...
    Write-Host 'application whitelisting, password protection, and privileged users'
    Write-Host '(standard users with admin privileges - Entra roles & nested AD groups).'
    Write-Host ''
